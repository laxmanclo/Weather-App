        ...
        if response_current.status_code == 200 and response_forecast.status_code == 200:
            try:
                ...
                if 'main' in weather_current and 'weather' in weather_current:
                    ...
                    set_window_background(weather_current['weather'][0]['main'])
...
def set_window_background(weather_condition):
    ...
    background_colors = {
        ...
        'Snow': '#FFFFFF',
        'light snow': '#00000'  # White
        # Add more weather conditions and corresponding background colors as needed
    }

    # Check if the weather condition has a corresponding background color
    if weather_condition in background_colors:
        window.configure(bg=background_colors[weather_condition])
    else:
        # Use a default background color if the weather condition is not mapped
